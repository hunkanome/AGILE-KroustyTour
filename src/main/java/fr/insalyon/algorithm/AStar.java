...
/**
 * Class implementing the A* algorithm using the geographical distance as
 * heuristic
 */
public class AStar extends Dijkstra {
	 ...
	 * @param endNode     another node (basically the end node of the shortest path
	 *                    we are computing)
	 * @return a float representing a distance (computed using the geographic
	 *         position of the two intersections)
	 * @see Intersection
	 * @see <a href=
	 *      "https://stackoverflow.com/questions/3694380/calculating-distance-between-two-points-using-latitude-longitude">Calculating
	 *      distance between two points, using latitude longitude?</a>
	 */
	@Override
